...
import { getRandomIntInclusive, makeId, getCurrencySymbol } from './util-service.js'
...
function getBookPrice(bookId){
    ...
    let currencySymbol = getCurrencySymbol(book.listPrice.currencyCode)
    return `${currencySymbol}${book.listPrice.amount}`
}
...
function updateBook(bookId, newInfo) {
...
function addBookReview(bookId, review) {
    ...
    console.log('book.reviews.length',book.reviews.length)
    // let nextReviewIdx = (book.reviews)? 0 : book.reviews.length
    // console.log(nextReviewIdx,'nextReviewIdx')
    // book.reviews.splice(nextReviewIdx, 1, review);
...
function _createBooks() {
    var books = []
    var vendors = ['audi', 'fiat', 'suzuki', 'honda']
    for (let i = 0; i < 4; i++) {
        var vendor = vendors[getRandomIntInclusive(0, 3)]
            ...
            "reviews" : [
                {
                    ...
                    readAt : '2/1/2018',
                    subject : 'Great Book!',
                    txt : 'placerat nisi sodales suscipit tellus tincidunt mauris elit sit luctus interdum',
                },
                {
                    id : makeId(),
                    name : 'Momo Ben David',
                    rate : 2,
                    readAt : '13/2/1985',
                    subject : 'Greates Book ever!!!',
                    txt : 'placerat nisi sodales su dunt mauris elit sit luctus interdum',
                },
                {
                    id : makeId(),
                    name : 'Books Reader2',
                    ...
                    readAt : '6/6/2004',
                    subject : 'mehh.. Book!',
                    txt : 'placerat nisi sodales suscipi sit luctus interdum',
                }
            ]
        },
        {
